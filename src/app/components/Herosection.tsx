    ...
    return(
        <div>         
            ...
            <div>
                ...
                <div className="border border-black ml-4 mt-6">
                <img height={200} width={120} src="https://cache3.pakwheels.com/system/car_generation_pictures/6000/original/Civic_10th_Gen_-_PNG.png?1635418859" alt="honda civic" />
                <h3 className="ml-4">Honda Civic</h3>
                <p className="text-green-500 text-sm ml-1">PKR 86.6-99.0 lacs</p>
                <p className="ml-4">★★★☆☆</p>
                </div>
                </Link>
              </div>
